...
import static com.infinite.gateway.common.constant.FallbackConstant.DEFAULT_FALLBACK_HANDLER_NAME;
...
import static com.infinite.gateway.common.enums.ResilienceEnum.*;
...
public class RouteDefinition {
    ...
    public static class ResilienceConfig {
        ...
        private int permittedNumberOfCallsInHalfOpenState = 1; // 断路器在半开状态下允许通过的调用次数
